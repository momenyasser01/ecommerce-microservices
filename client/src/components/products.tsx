...
const Products = () => {
  ...
  return (
    <div className="2xl:w-[64%] w-[80%] flex flex-col gap-20 pb-10">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
        {products &&
          products.length > 0 &&
