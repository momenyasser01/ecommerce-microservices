...
const Products = () => {
  ...
  return (
    <div className="w-[60%] md:w-[85%] flex flex-col gap-20 pb-10">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-8 gap-4">
        {products &&
          products.length > 0 &&
